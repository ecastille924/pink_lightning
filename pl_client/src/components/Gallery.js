    ...
    render() {
        return (
            <div>
                ...
                <img src= '../images/pl1.jpg' alt="" className="image" />
                <img src= '../images/pl2.jpg' alt="" className="image" />
                ...
                <img src= '../images/pl9.jpg' alt="" className="image" />
                <img src= '../images/pl10.jpg' alt="" className="image" />
